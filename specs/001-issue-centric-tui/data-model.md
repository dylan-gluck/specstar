...
interface SpecstarConfig {
  ...
  /** Directories to scan for workflow YAML definitions. */
  workflowDirs: string[];
}
```

### 7.2 SpecstarKeybindings

Updated from the original four-card grid navigation to master-detail navigation.
